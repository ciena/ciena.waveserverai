...
DOCUMENTATION = """
author: Ciena
netconf: waveserverai
short_description: Use waveserverai netconf plugin to run netconf commands on Ciena waveserverai
  platform
description:
- This waveserverai plugin provides low level abstraction apis for sending and receiving
  netconf commands from Ciena waveserverai network devices.
version_added: 1.0.0
options:
  ncclient_device_handler:
    ...
    default: default
    description:
    - Specifies the ncclient device handler name for Ciena waveserverai network os. To
...
class Netconf(NetconfBase):
    ...
    def get_device_info(self):
        device_info = dict()
        device_info["network_os"] = "waveserverai"
        return device_info
